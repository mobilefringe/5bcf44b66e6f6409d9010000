                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="map_search_container margin_30">
                                <search-component v-model="storeSearch" :list="processedStores" :suggestion-attribute="suggestionAttribute" @select="onOptionSelect" :placeholder="$t('stores_page.find_your_store')" inputID="mapSearch">
                            ...
                            <div class="store_list_container hidden_phone">
                        ...
                        <div class="col-md-9">
                            <mapplic-map ref="mapplic_ref" :height="640" :minimap= "false" :deeplinking="false" :sidebar="false" :hovertip="true" :maxscale= "5" :storelist="allStores" :floorlist="floorList" tooltiplabel="View Store Details"></mapplic-map>
                        </div>
                    </div>
                </div>
            </div>
