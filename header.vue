			...
			<div class="header_logo">
				<div class="hidden_phone">
                    ...
                    <div class="header_hours">
                        ...
                        <p v-if="todaysHours.is_closed == null || !todaysHours.is_closed">Open Now: {{todaysHours.open_time | moment("h:mma", timezone)}} - {{todaysHours.close_time | moment("h:mma", timezone)}}</p>
                        <p v-else>Country Club Mall is currently closed.</p>
                    </div>
				</div>
				<div class="mobile_header">
				    <div class="property_logo center-block">
						<router-link to="/">
						    <img src="//codecloud.cdn.speedyrails.net/sites/5bcf44b66e6f6409d9010000/image/png/1562336708799/CCM-Logo-ColorHQ.png" :alt="property.name + ' Logo'"/>
					    </router-link>
					</div>
