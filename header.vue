			...
			<div class="header_logo">
				<div class="hidden_phone">
                    ...
                    <div class="header_hours">
                        ...
                        <p v-if="todays_hours.is_closed == null || !todays_hours.is_closed">Open Now: {{todays_hours.open_time | moment("h:mma", timezone)}} - {{todays_hours.close_time | moment("h:mma", timezone)}}</p>
                        <p v-else>Closed</p>
                    </div>
				</div>
